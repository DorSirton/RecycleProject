...
namespace RecyclingProject.Data.Model
{
    public partial class Recycler
    {
        ...
        [Column("Num_Of_Collected_Points")]
        [Display(Name = "Number of collecting points")]
        public int? NumOfCollectedPoints { get; set; } = 0;

        [ForeignKey("AddressId")]
        [InverseProperty("Recyclers")]
        public virtual Address Address { get; set; } = null!;
        [InverseProperty("Recycler")]
